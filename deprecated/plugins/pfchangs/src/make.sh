...
DATA_PATH=/usr/lib/enigma2/python/Plugins/Extensions/PFChangs
#DATA_FILES="README.txt pfchangs.png setup.xml plugin.pyo upnpclient.pyo __init__.pyo"
DATA_FILES="README.txt pfchangs.png setup.xml plugin.pyo __init__.pyo"
...
touch plugin.py __init__.py upnpclient.py
#python -O -m compileall plugin.py __init__.py upnpclient.py
